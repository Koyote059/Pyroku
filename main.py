...
app = Client(
    "my_account",
    api_id= "2728290", # Inserisci tra queste virgolete il tuo api_id
    api_hash="b2cad5420a9f66e60add719aefdfaaf6",
    bot_token="1399159141:AAFc2-7lOQR4VOCcF7wHku7MoHZBQqzPdXU"

) # Inserisci tra queste virgolete il tuo api_id
